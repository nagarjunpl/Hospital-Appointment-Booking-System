...
const [selectedDate, setSelectedDate] = useState(new Date());
 ...
 const fetchdata = async () => {
    try {
      const response = await axios.get(`https://hospital-appointment-booking-system-6hcp.onrender.com/single/${id}`, {
        headers: {
...
const handlesave=async()=>{
  ...
  try {
    ...
    const response = await axios.patch(`https://hospital-appointment-booking-system-6hcp.onrender.com/update-date`, {_id:id,date:selectedDate}, {
      headers: {
        'Content-Type': 'application/json',
        authorization: localStorage.getItem('jwt'),
      },
  ...
  const handleSubmit = async(e) => {
    ...
    try {
        const response = await axios.patch(`https://hospital-appointment-booking-system-6hcp.onrender.com/update-medicine`, {_id:id,medicine,about}, {
          headers: {
            'Content-Type': 'application/json',
            authorization: localStorage.getItem('jwt'),
          },
